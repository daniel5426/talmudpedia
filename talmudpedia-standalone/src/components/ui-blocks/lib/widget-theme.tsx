...
export const THEME_INK: WidgetTheme = {
  ...
  kpiValue: "text-3xl font-light tabular-nums text-slate-900",
  ...
  tableHeader: "text-right text-[14px] font-bold uppercase tracking-wider text-slate-400",
  tableHeaderBorder: "border-b-1 border-slate-400",
  tableCell: "text-slate-700",
  tableCellBorder: "border-b border-slate-100",
