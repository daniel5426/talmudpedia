  ...
  return (
    <HoverCard>
      <HoverCardTrigger asChild>
        <div
          className={cn(
            "group relative flex h-8 cursor-default select-none items-center gap-1.5 rounded-md border border-border bg-background px-1.5 text-sm font-medium transition-all hover:bg-accent hover:text-accent-foreground",
            className
          )}
          key={data.id}
          {...props}
...
export function PromptInputAttachments({
  ...
  return (
    <div className={cn("relative z-20 flex flex-wrap items-center gap-2 p-3", className)} {...props}>
