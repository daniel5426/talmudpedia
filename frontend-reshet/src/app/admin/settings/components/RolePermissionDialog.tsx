...
const PROJECT_RESOURCES: PermissionResource[] = [
  ...
  },
  {
    id: "agents",
    label: "Agents",
    description: "Build, execute, and test agents inside the project.",
    readScopes: ["agents.read"],
    writeScopes: ["agents.read", "agents.write", "agents.execute", "agents.run_tests"],
  },
  {
    id: "threads",
    label: "Threads",
  ...
  },
  {
    ...
    description: "Read and manage project settings.",
    readScopes: ["project_settings.read"],
    writeScopes: ["project_settings.read", "project_settings.write"],
  },
  {
    id: "project_members",
    label: "Project Members",
    description: "Review and manage explicit project access.",
    readScopes: ["project_members.read"],
    writeScopes: ["project_members.read", "project_members.write"],
    dangerous: true,
  },
  {
    id: "project_api_keys",
    ...
    readScopes: ["project_api_keys.read"],
    writeScopes: ["project_api_keys.read", "project_api_keys.write"],
    dangerous: true,
  },
  {
    id: "publish",
    label: "Publish",
    description: "Promote draft resources to published project outputs.",
    readScopes: ["apps.publish", "agents.publish", "tools.publish", "artifacts.publish"],
    writeScopes: ["apps.publish", "agents.publish", "tools.publish", "artifacts.publish"],
    dangerous: true,
  },
  {
    id: "exposure",
    label: "Exposure",
    description: "Manage public or embedded runtime exposure settings.",
    readScopes: ["apps.exposure.write", "agents.embed"],
    writeScopes: ["apps.exposure.write", "agents.embed"],
    dangerous: true,
  },
]
