...
export const ConversationScrollButton = ({
  ...
  return (
    !isAtBottom && (
      <Button
        className={cn(
          "absolute bottom-4 z-50 left-[50%] translate-x-[-50%] rounded-full shadow-md",
          className
        )}
