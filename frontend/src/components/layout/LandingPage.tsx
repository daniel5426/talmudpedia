...
function LibraryCard({ title, description, evervaultText }: LibraryCardProps) {
  return (
    <div className="border border-black/[0.2] dark:border-white/[0.2] flex flex-col items-start max-w-[13rem] bg-white/10 backdrop-blur-md mx-auto p-4 relative h-[20rem]">
      <Icon className="absolute h-6 w-6 -top-3 -left-3 dark:text-white text-black" />
      <Icon className="absolute h-6 w-6 -bottom-3 -left-3 dark:text-white text-black" />
      <Icon className="absolute h-6 w-6 -top-3 -right-3 dark:text-white text-black" />
      <Icon className="absolute h-6 w-6 -bottom-3 -right-3 dark:text-white text-black" />
      <EvervaultCard text={evervaultText} className="size-[11rem] " />
      <h2 className="dark:text-white text-white mt-4 text-sm font-light">
        {description}
      </h2>
      <p className="text-sm border font-light dark:border-white/[0.2] border-black/[0.2] rounded-full mt-2 text-black dark:text-white px-2 py-0.5">
        עיין עכשיו
      </p>
    </div>
  );
...
export function LandingPage({
  ...
  return (
    <div ref={containerRef} className="relative flex flex-col bg-transparent min-h-screen">
      {/* Hero Section */}
      <div className="flex flex-col items-center px-4 pt-20 pb-72 relative z-10">
      ...
      <div className="w-full h-[900px] flex justify-center items-center opacity-60 relative z-0">
