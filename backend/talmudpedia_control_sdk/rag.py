...
class RagAPI:
    ...
    def get_visual_pipeline(self, pipeline_id: str, tenant_slug: Optional[str] = None) -> ResponseEnvelope:
        return self._client.request(
            "GET",
    ...
    def list_pipeline_versions(self, pipeline_id: str, tenant_slug: Optional[str] = None) -> ResponseEnvelope:
        return self._client.request(
            "GET",
    ...
    def get_executable_pipeline(self, exec_id: str, tenant_slug: Optional[str] = None) -> ResponseEnvelope:
        return self._client.request(
            "GET",
    ...
    def get_executable_input_schema(self, exec_id: str, tenant_slug: Optional[str] = None) -> ResponseEnvelope:
        return self._client.request(
            "GET",
    ...
    def get_job(self, job_id: str, tenant_slug: Optional[str] = None) -> ResponseEnvelope:
        return self._client.request(
            "GET",
    ...
    def list_job_steps(self, job_id: str, lite: bool = True, tenant_slug: Optional[str] = None) -> ResponseEnvelope:
