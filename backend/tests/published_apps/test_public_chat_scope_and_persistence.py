...
from ._helpers import admin_headers, install_stub_agent_worker, seed_admin_tenant_and_agent, seed_published_app
...
async def test_preview_chat_stream_uses_preview_token_and_persists_thread(client, db_session, monkeypatch):
    ...
    install_stub_agent_worker(monkeypatch, content="Preview response")
