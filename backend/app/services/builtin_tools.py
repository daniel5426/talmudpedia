...
def _widget_value_schema() -> dict[str, Any]:
    return {
        "oneOf": [
            {"type": "string"},
            {"type": "number"},
...
def _widget_format_schema() -> dict[str, Any]:
    return {
        "type": "string",
...
def _widget_title_schema() -> dict[str, Any]:
    return {"type": "string"}


def _widget_trend_schema() -> dict[str, Any]:
    return {
        "type": "object",
        "properties": {
            "value": {"type": "number"},
...
def _widget_stat_spec_schema() -> dict[str, Any]:
    return {
        "type": "object",
        "properties": {
            "value": _widget_value_schema(),
            "label": {"type": "string"},
            "format": _widget_format_schema(),
            "trend": _widget_trend_schema(),
        },
        "required": ["value"],
        "additionalProperties": False,
    }
...
def _widget_table_spec_schema() -> dict[str, Any]:
    return {
        "type": "object",
        "properties": {
            "columns": {
...
def _widget_chart_row_schema() -> dict[str, Any]:
    return {
        "type": "object",
        "additionalProperties": True,
    }
...
def _widget_chart_label_value_row_schema() -> dict[str, Any]:
    return {
        "type": "object",
        "properties": {
            "label": {"type": "string"},
...
def _widget_cartesian_spec_schema() -> dict[str, Any]:
    return {
        "oneOf": [
            {
                "type": "object",
                "properties": {
                    "data": {
                        "type": "array",
                        "minItems": 1,
                        "items": _widget_chart_row_schema(),
                    },
                    "xKey": {"type": "string"},
                    "yKey": {"type": "string"},
            ...
            },
            {
                ...
                "properties": {
                    "data": {
                        "type": "array",
                        "minItems": 1,
                        "items": _widget_chart_label_value_row_schema(),
                    },
                    "seriesLabel": {"type": "string"},
                    "format": _widget_format_schema(),
                },
...
def _widget_pie_spec_schema() -> dict[str, Any]:
    return {
        "oneOf": [
            {
                "type": "object",
...
def _emit_widget_input_schema() -> dict[str, Any]:
    def _variant(widget_type: str, spec_schema: dict[str, Any]) -> dict[str, Any]:
        return {
            "type": "object",
            "properties": {
                "widget_type": {
                ...
                "title": _widget_title_schema(),
                "subtitle": _widget_title_schema(),
                "spec": spec_schema,
            },
    ...
    return {
        "oneOf": [
            _variant("stat", _widget_stat_spec_schema()),
            _variant("table", _widget_table_spec_schema()),
            _variant("bar_chart", _widget_cartesian_spec_schema()),
            _variant("line_chart", _widget_cartesian_spec_schema()),
            _variant("pie_chart", _widget_pie_spec_schema()),
        ]
    }
...
def _specs() -> list[BuiltinToolTemplateSpec]:
    ...
    emit_widget_input = _emit_widget_input_schema()
    emit_widget_output = {
        "type": "object",
        "properties": {
            "ok": {"type": "boolean"},
