...
def build_architect_graph_definition(model_id: str, tool_ids: list[str] | None = None) -> dict:
    instructions = (
        ...
        "platform-assets, platform-governance, architect-worker-binding-prepare, architect-worker-binding-get-state, "
        ...
        "For code-heavy or multi-file artifact authoring, prepare an artifact_shared_draft binding with architect-worker-binding-prepare, "
        "spawn the artifact worker asynchronously with architect-worker-spawn or architect-worker-spawn-group, inspect child progress with "
