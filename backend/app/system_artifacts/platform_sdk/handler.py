...
def _publish_artifact(client: Client, payload: Dict[str, Any], dry_run: bool) -> Tuple[Optional[Dict[str, Any]], List[Dict[str, Any]]]:
    return artifact_actions.publish(
        client,
        payload,
        dry_run,
        control_client_factory=_control_client,
...
def _dispatch_action(
    *,
    ...
    handlers = {
        ...
        "rag.create_pipeline_shell": lambda: rag_actions.create_pipeline_shell(client, payload, dry_run, control_client_factory=_control_client, request_options_builder=_request_options),
        ...
        "agents.create_shell": lambda: agent_actions.create_shell(client, payload, dry_run, control_client_factory=_control_client, request_options_builder=_request_options),
        ...
        "agents.nodes.catalog": lambda: agent_actions.nodes_catalog(client, payload, control_client_factory=_control_client),
        "agents.nodes.schema": lambda: agent_actions.nodes_schema(client, payload, control_client_factory=_control_client),
        "agents.nodes.validate": lambda: agent_actions.nodes_validate(client, payload, control_client_factory=_control_client),
