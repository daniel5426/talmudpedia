...
- protocol dumps
- machine-generated reports intended to be preserved

## Rules
- Generated files should be clearly labeled as generated.
- Prefer deterministic regeneration over manual editing.
- If a generated file becomes part of a human decision workflow, add a hand-written companion doc in `references/` or `design-docs/`.
